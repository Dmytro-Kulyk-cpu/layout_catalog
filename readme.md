...
❗️ Replace `<Dmytro-Kulyk-cpu>` with your Github username and copy the links to `Pull Request` description:
- [DEMO LINK](https://Dmytro-Kulyk-cpu.github.io/layout_catalog/)
- [TEST REPORT LINK](https://Dmytro-Kulyk-cpu.github.io/layout_catalog/report/html_report/)
